      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center"><i className="fas fa-phone-alt text-amber-500 mr-3"></i><span className="text-white/70">+254 711 346177</span></li>
            <li className="flex items-center"><i className="fas fa-envelope text-amber-500 mr-3"></i><span className="text-white/70">hello@monarchgroom.com
            </span></li>
          </ul>
        </div>
      </div>
