      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select name="service" value={formData.service} onChange={handleChange} required className="w-full p-2 rounded bg-white/10">
            <option  class="blank" value="">Select a service</option>
        ...
        <div>
          ...
          <select name="barber" value={formData.barber} onChange={handleChange} required className="w-full p-2 rounded bg-black/10">
