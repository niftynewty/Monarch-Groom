...
import { FiCalendar, FiCheck, FiTrash2, FiClock, FiUser, FiScissors } from "react-icons/fi";

const AppointmentsTab = ({ appointments, services, barbers, users, loading }) => {
  ...
  const statusOptions = [
    { value: 'pending', label: 'Pending', color: 'bg-yellow-100 text-yellow-800', icon: <FiClock className="mr-1" /> },
    { value: 'confirmed', label: 'Confirmed', color: 'bg-blue-100 text-blue-800', icon: <FiCheck className="mr-1" /> },
    { value: 'completed', label: 'Completed', color: 'bg-green-100 text-green-800', icon: <FiCheck className="mr-1" /> },
    { value: 'cancelled', label: 'Cancelled', color: 'bg-red-100 text-red-800', icon: <FiTrash2 className="mr-1" /> },
  ];
              ...
              >
                ...
                <div className="col-span-3">
                  <div className="font-semibold text-blue-950 flex items-center">
                    ...
                    {service?.title || appointment?.service || "Unknown Service"}
                  </div>
                  <div className="text-xs text-blue-700 mt-1">
                    {service?.duration ? `${service.duration} mins` : 'Duration not specified'} • 
